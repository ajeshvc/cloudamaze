 ...
 <!--- <h2> <img src="images/lemon-slice.png" /><font color="#9dc33c"> Easy Peasy </font><font color="#61c8d9"> Lemon squeezy!</font></h2>
    ...
    <div style="width:100%;height:auto;">
        ...
        <div style="width:70%;text-align: right;">
            <div><h2><font style="color:#9dc33c;text-align: right;"> Easy Peasy </font><font color="#61c8d9"> Lemon squeezy!</font></h2></div>
        </div>
        <div><h3> 3 steps away </h3>  <i>Note: hitting register now will open a new tab, you can make your domain registration request there and be right back.</i>
        </div>
    </div>   
--->
 <div style="width:100%;height:auto;">
