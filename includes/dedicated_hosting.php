...
if(isset($_POST['submit'])&&$_POST['submit']=='Submit'){
   ...
   if($flag==1){
       ...
       $currentdate = date("Y/m/d");
                ...
                VALUES('4','$currentdate','$name','$cp','$address','$phone','$mobile','$email','$web','$des') ");
                 $id=mysql_insert_id();
                 $invoice = "#hiDHost00". $id;
              ...
              // mail   
                    ...
                    $from = $_POST["email"];
                    $to = $to_email;
                    $message = "|Dedicated Hosting " . "|Invoice Id " . $invoice . $email_details;
                    $subject = $name . "- New Dedicated Hosting Request";
                    $message = $message . "\n\n" . "-------------------\n". "on-" . $currentdate;
                    $message = str_replace("|", "\n\n", $message);
...
<div class="form_outer">
    ...
    <div class="form_content">
    	<div id="stylized" class="myform">
            <?php if($invoice==""){ ?>
            <form id="form" name="form" method="post" action="/dedicated-hosting">
                <h1>Query From</h1>
