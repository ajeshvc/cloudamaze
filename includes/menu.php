<div id="menu-bar-container">
    ...
    <ul id="menu-bar">
     <li <?php if(!isset($page) || (isset($page) && $page==0)){ ?>   class="current" <?php  } ?> ><a href="index.php">Home</a></li>
     <li <?php if(isset($page) && $page==1 || (isset($page) && $page==2) ){ ?>   class="current" <?php  } ?>><?php $_SESSION['skip']="false" ?><a href="index.php?page=register">Domain</a></li>
     <li <?php if((isset($page) && $page==5) || (isset($page) && $page==11) || (isset($page) && $page==13) ){ ?>   class="current"  <?php  } ?> ><a href="index.php?page=shared-hosting">Hosting</a>
         <ul>
           <li><a href="index.php?page=shared-hosting">Shared Hosting</a></li>
           <li><a href="index.php?page=vps">Virtual Private Servers</a></li>
           <li><a href="index.php?page=dedicated-hosting">Dedicated Hosting</a></li>
         </ul>
     </li>     
     
     <li  <?php if((isset($page) && $page==7) || (isset($page) && $page==8) || (isset($page) && $page==9) || (isset($page) && $page==10) ){ ?>   class="current" style="text-shadow: none;" <?php  } ?> ><a href="index.php?page=corporate-email">Services</a>
     	<ul>
        	<li><a href="index.php?page=corporate-email">Corporate Email</a></li>
            <li><a href="index.php?page=ssl-certificate">SSL Certificate</a></li>
           	<li><a href="index.php?page=payment-gateway">Payment Gateway</a></li>
           	<li><a href="index.php?page=server-management">Server Management</a></li>
        </ul>
     </li>
     <li><a href="http://blog.cloudamaze.com/" target="_blank">Blog</a></li>
     <li <?php if(isset($page) && $page==6){ ?>   class="current" <?php  } ?> ><a href="index.php?page=testimonials">Testimonials</a></li>
     <li <?php if(isset($page) && $page==14){ ?>   class="current" <?php  } ?>><a href="index.php?page=downloads">Downloads</a></li>
     <li <?php if(isset($page) && $page==15){ ?>   class="current" <?php  } ?> ><a href="index.php?page=support" >Support</a></li>
     <li <?php if(isset($page) && $page==12){ ?>   class="current" <?php  } ?> ><a href="index.php?page=contact-us">Contact Us</a></li>
     <li <?php if((isset($page) && $page==17) || (isset($page) && $page==18) || (isset($page) && $page==19) || (isset($page) && $page==20)  ){ ?>   class="current" style="text-shadow: none;" <?php  } ?> ><a href="index.php?page=about-us">More Info</a>
            <ul>
           <li><a href="index.php?page=about-us">About Us</a></li>
           <li><a href="index.php?page=terms">Terms and Conditions </a></li>
           <li><a href="index.php?page=privacy-policies">Privacy policies</a></li>
           <li><a href="index.php?page=refund">Refund and Cancellation</a></li>
         </ul>
